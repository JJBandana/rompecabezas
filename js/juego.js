...
function mostrarCartelGanador(){
    //if (chequearSiGano == true){
        alert("¡Felicidades! Has completado el rompecabezas.");alert("Para volver a jugar recarga la página.");
    //}
}
...
function intercambiarPosiciones(filaPos1, columnaPos1, filaPos2, columnaPos2){
    ...
    var e1=document.getElementById("pieza"+grilla[filaPos1][columnaPos1]);
    var e2=document.getElementById("pieza"+grilla[filaPos2][columnaPos2]);
    var clon1=e1.cloneNode(true);
    var clon2=e2.cloneNode(true);
    var padre = e1.parentNode;
    padre.replaceChild(clon1,e2);
    padre.replaceChild(clon2,e1);
}
